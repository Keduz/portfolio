...
export const projects: Project[] = [
  {
    slug: 'nexus-ai-trading',
    title: 'NEXUS AI — Trading Autonomo',
    shortTitle: 'NEXUS AI Trading',
    subtitle: 'Landing page sci-fi para robo de trading autonomo com IA',
    description: 'Landing page imersiva com visual cockpit espacial para plataforma de trading autonomo com inteligencia artificial. Cena 3D interativa com Three.js, efeitos HUD/cyberpunk, chart de trading ao vivo e micro-interacoes avancadas.',
    category: 'sistemas',
    ...
    status: 'Concluido',
    statusType: 'done',
    problem: 'Plataforma de trading com IA precisava de uma landing page que transmitisse tecnologia de ponta e confianca para atrair traders e investidores.',
    context: 'Mercado de fintechs e robos de trading e altamente competitivo. A landing page precisa impressionar visualmente e converter visitantes em usuarios da plataforma.',
    solution: 'Landing page imersiva com visual de cockpit espacial usando Three.js para cena 3D interativa, efeitos cyberpunk (glitch, data rain, scan lines), chart de trading canvas animado e micro-interacoes que reforçam a narrativa de tecnologia avancada.',
    objective: 'Criar uma experiencia visual unica que faca o visitante sentir que esta dentro de uma estacao espacial de trading, maximizando conversao.',
    techs: [
      { name: 'HTML5', role: 'Estrutura semantica completa em arquivo unico', icon: 'devicon-html5-plain' },
      { name: 'CSS3', role: 'Design system HUD/Sci-Fi com clip-paths, animacoes e efeitos cyberpunk', icon: 'devicon-css3-plain' },
      { name: 'JavaScript', role: 'Engine completa de interacoes, efeitos e logica do site', icon: 'devicon-javascript-plain' },
      { name: 'Three.js', role: 'Cena 3D com orbe central, particulas, shaders customizados e grid Tron', icon: 'devicon-threejs-original' },
    ],
    metrics: [
      { value: '2500+', label: 'Linhas de codigo' },
      { value: '3D', label: 'Cena interativa' },
      { value: '15+', label: 'Efeitos visuais' },
      { value: '100%', label: 'Responsivo' },
    ],
    flowSteps: [
      { title: 'Design System Sci-Fi', description: 'Definicao da paleta cyberpunk, tipografia Orbitron/Rajdhani e efeitos HUD' },
      { title: 'Cena 3D Three.js', description: 'Orbe central com fresnel shader, eletrons orbitais, data streams, nebula e grid Tron' },
      { title: 'Efeitos e Interacoes', description: 'Glitch text, typing effect, number scramble, data rain, cursor customizado e trade terminal' },
      { title: 'Chart de Trading', description: 'Canvas chart animado com area chart, buy/sell markers, tooltip e atualizacao ao vivo' },
      { title: 'Polish e Responsividade', description: 'Loading screen, scroll progress, easter egg Konami code e adaptacao mobile/tablet/desktop' },
    ],
    heroVisualType: 'monitor',
    liveUrl: 'https://keduz.github.io/nexus-trading-site/',
  },
  {
